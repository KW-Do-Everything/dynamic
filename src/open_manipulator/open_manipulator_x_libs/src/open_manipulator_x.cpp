  ...
  /*****************************************************************************
    ...
    *****************************************************************************/
    ...
    addJoint("joint1",  // my name
             "world",   // parent name
             "joint2",  // child name
             math::vector3(0.0, 0.0, 0.40),                // relative position
             math::convertRPYToRotationMatrix(0.0, 0.0, 0.0), // relative orientation
             Z_AXIS,    // axis of rotation
             dxl_id[0], // actuator id
             M_PI,      // max joint limit (3.14 rad)
             -15*M_PI/180,     // min joint limit (-3.14 rad)
             1.0,       // coefficient
             1.0483260e-01,                                                        // mass
    ...
    addJoint("joint2",  // my name
             "joint1",  // parent name
             "joint3",  // child name
             math::vector3(0.0585, -0.144, 0.0),                // relative position
             math::convertRPYToRotationMatrix(0.0, 0.0, 0.0), // relative orientation
             Z_AXIS,    // axis of rotation
             dxl_id[1], // actuator id
             M_PI_2,    // max joint limit (1.67 rad)
             -M_PI_2,     // min joint limit (-2.05 rad)
             1.0,       // coefficient
             1.4234630e-01,                                                        // mass
    ...
    addJoint("joint3",  // my name
             "joint2",  // parent name
             "joint4",  // child name
             math::vector3(0.1365, 0.0, -0.0675),               // relative position
             math::convertRPYToRotationMatrix(0.0, 0.0, 0.0), // relative orientation
             Y_AXIS,    // axis of rotation
             dxl_id[2], // actuator id
             2.090336,      // max joint limit (1.53 rad)
             -2.090336,   // min joint limit (-1.67 rad)
             1.0,       // coefficient
             1.3467049e-01,                                                        // mass
    ...
    addJoint("joint4",  // my name
             "joint3",  // parent name
             "joint5", // child name
             math::vector3(0.0, 0.0, -0.06916),                 // relative position
             math::convertRPYToRotationMatrix(0.0, 0.0, 0.0), // relative orientation
             Y_AXIS,    // axis of rotation
             dxl_id[3], // actuator id
             2.090336 + (M_1_PI/180) * 3,       // max joint limit (2.0 rad)
             -2.090336 - (M_1_PI/180) * 3,      // min joint limit (-1.8 rad)
             1.0,       // coefficient
             1.6512361e-01,                                                        // mass
    ...
    addJoint("joint5",  // my name
             ...
             2.090336 ,       // max joint limit (2.0 rad)
             -2.090336 ,      // min joint limit (-1.8 rad)
             1.0,       // coefficient
             1.6512361e-01,                                                        // mass
             math::inertiaMatrix(9.9192159e-05, 7.1970402e-09, -6.4649200e-05,
                                                4.7615217e-04, -2.2085254e-07,
    ...
    addJoint("joint6",  // my name
             "joint5",  // parent name
             "gripper1", // child name
             math::vector3(0.0, 0.0, -0.229513),                 // relative position x -> 0.046/ z -> -0.0664
             math::convertRPYToRotationMatrix(0.0, 0.0, 0.0), // relative orientation
             Z_AXIS,    // axis of rotation
    ...
    addTool("gripper1",  // my name
            "joint5",   // parent name
            math::vector3(0.0, 0.0, 0.0),                 // relative position -0.124
            math::convertRPYToRotationMatrix(0.0, 0.0, 0.0), // relative orientation
            -1,  // actuator id
...
//  kinematics_ = new kinematics::SolverUsingCRAndJacobian();
